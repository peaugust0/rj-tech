...
export const metadata: Metadata = {
  ...
  description:
    "Preview navegável: portal que unifica financeiro, prestadores, escala, concentração de clientes e contratos de uma empresa de home care. Demonstração RJ Technology — somente visualização.",
